...
import api.BaseApi.HttpRequestType.DELETE
...
abstract class BaseApi: KoinComponent {
     ...
     * REQUEST TYPE
     */
    protected enum class HttpRequestType {
        GET,
        POST,
        DELETE
    }
    ...
    protected fun sendAnalyticUnexpectedError(error: NoErrorExpected) {
        ...
        logMessage("HttpClient unexpected error: ${error.route} = ${error.errorMessage}")
    }

    protected companion object {
        const val BASE_URL = "http://10.0.2.2:8080" // TODO: Move to AppConfig
    }
}